...
class WarehouseTransferDialog extends StatefulWidget {
  const WarehouseTransferDialog({super.key});
...
class _WarehouseTransferDialogState extends State<WarehouseTransferDialog> {
  ...
  final _refController = TextEditingController(text: 'MIG-TRF-12');

  String _selectedProduct = 'Select Product...';
  String _fromWarehouse = 'Select Source...';
  String _toWarehouse = 'Select Destination...';
            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildLabel('Select Product', isRequired: true),
                    _buildDropdown(
                      value: _selectedProduct,
                      items: ['Select Product...', 'Product A - Electronics', 'Product B - Apparel', 'Product C - Groceries'],
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('From Warehouse', isRequired: true),
                              _buildDropdown(
                                value: _fromWarehouse,
                                items: ['Select Source...', 'Warehouse A', 'Warehouse B', 'Central Hub'],
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('To Warehouse', isRequired: true),
                              _buildDropdown(
                                value: _toWarehouse,
                                items: ['Select Destination...', 'Warehouse A', 'Warehouse B', 'Central Hub'],
                    ...
                    _buildLabel('Quantity to Move', isRequired: true),
                    _buildTextField(
                    ...
                    _buildLabel('Transfer Ref / ID', isRequired: true),
                    _buildTextField(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          AppSnackbar.show(
                            context,
                            'Transfer release initiated successfully.',
                            type: SnackType.success,
                          );
                          Navigator.pop(context);
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: const Color(0xFF7B2CBF), // Purple matching theme
