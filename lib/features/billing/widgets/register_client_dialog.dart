...
class _RegisterClientDialogState extends State<RegisterClientDialog> {
  final _nameController = TextEditingController(text: 'Aditya Birla, Rohan Sharma...');
  final _emailController = TextEditingController();
  final _incomeController = TextEditingController(text: '1200000');
            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildLabel('TAXPAYER FULL NAME', isRequired: true),
                    _buildTextField(
                      controller: _nameController,
                      hint: 'Aditya Birla, Rohan Sharma...',
                    ),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('TAX REGIME', isRequired: true),
                              _buildDropdown(
                                value: _selectedRegime,
                                items: ['New Tax Regime', 'Old Tax Regime'],
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('EST. ANNUAL INCOME (₹)', isRequired: true),
                              _buildTextField(
