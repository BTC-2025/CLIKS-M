...
class DispatchBillDialog extends StatefulWidget {
  ...
  @override
  State<DispatchBillDialog> createState() => _DispatchBillDialogState();
}

class _DispatchBillDialogState extends State<DispatchBillDialog> {
  final _transporterController = TextEditingController(text: 'Bluedart Cargo');
  final _vehicleController = TextEditingController(text: 'MH-02-EH-9081');
            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    _buildLabel('Transporter Company Name', isRequired: true),
                    _buildTextField(
                      controller: _transporterController,
                      hint: 'e.g. Bluedart Cargo',
                    ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('Distance (Kms)', isRequired: true),
                              _buildTextField(
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('Dispatch Location', isRequired: true),
                              _buildTextField(
                        ...
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildLabel('Delivery Destination', isRequired: true),
                              _buildTextField(
