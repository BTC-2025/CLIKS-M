...
class _PeoplePageState extends ConsumerState<PeoplePage> {
  ...
  void _openContactLedgerModal(Map<String, dynamic> contact, bool isMobile) {
    int activeForm = 0; // 0: View Stand, 1: Record Tx Form (Screenshot 4), 2: Maturity Alarm Form (Screenshot 3)

    // Form 1 Controllers (Record Tx)
    String direction = 'I Borrowed Money (-)'; // or 'I Lent Money (+)'
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  // Header Profile Banner matching Screenshot 2
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 24,
                  ...
                  // Consolidated Ledger Stand Card matching Screenshot 2
                  Container(
                    width: double.infinity,
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                  ...
                  if (activeForm == 0) ...[
                    ...
                    // Action Buttons at Bottom matching Screenshot 2
                    Row(
                      children: [
                        Expanded(
                    ...
                    // FORM 1: LOG NEW ENTRY (Screenshot 4)
                    Container(
                      padding: const EdgeInsets.all(14),
                      decoration: BoxDecoration(
                        color: const Color(0xFFF8FAFC),
                    ...
                    // FORM 2: SET MATURITY ALARM (Screenshot 3)
                    Container(
                      padding: const EdgeInsets.all(14),
                      decoration: BoxDecoration(
                        color: const Color(0xFFFFFBEB),
